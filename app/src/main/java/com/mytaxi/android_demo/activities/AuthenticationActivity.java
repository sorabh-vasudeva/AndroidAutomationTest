...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    3. both Username and Password fields are empty */

                else if (username.isEmpty() && password.isEmpty()) {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.blank_username_password, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Login Failed due to blank username and password ");
                } else if (username.isEmpty()) {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.blank_username, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Login failed due to blank Username ");
                } else if (password.isEmpty()) {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.blank_password, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Login failed due to blank Password ");
                } else {
                    View view = findViewById(android.R.id.content);
